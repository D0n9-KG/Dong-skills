...
$sourceMarker = [pscustomobject]@{
  ...
  note = "Generated by Dong Skills install-windows.ps1. Installed skill copies are not the source repo."
}
[System.IO.File]::WriteAllText((Join-Path $TargetSkillsRoot ".dong-skills-source.json"), (($sourceMarker | ConvertTo-Json -Depth 5) + [Environment]::NewLine), $utf8NoBom)
